...
{	
	...
	timer_enable(4, timer4_callback, 32768*180, 1);  //timer4为24位timer，最大支持1024s的定时  这里定义一个180s的定时器来校准内部32.768Khz时钟源
	...
	{				
		...
		{
			timer180s_flag=0;
			sys_32k_lpo_calibration();  //建议3分钟校准一次
		}
